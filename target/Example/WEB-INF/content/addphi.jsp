	...
	<div class="col-lg-6 col-lg-offset-3">
		<div class="well">
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
						<s:form id="myForm" action="addphi" theme="bootstrap"
							validate="true" cssClass="bs-example form-horizontal"
							method="post">
							<fieldset>
								<legend align="center">Add PHI Details</legend>

								<s:textfield label="Name" name="name"
									cssClass="col-lg-11" placeholder="Name" />

								<s:textfield label="NIC" name="nic"
									cssClass="col-lg-11" placeholder="NIC" />

								<s:textfield label="PHI Division" name="phidivision"
									cssClass="col-lg-11" placeholder="PHI Division" />
								...
								<s:hidden name="pageName" value="addphi" />
							</fieldset>
						</s:form>
					</div>
				</div>
